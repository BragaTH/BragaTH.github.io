...
const countries = [
    ...
    { name: "República Dominicana", code: "do", difficulty: "hard" },
    ...
    { name: "Síria", code: "sy", difficulty: "hard" },
    { name: "Iêmen", code: "ye", difficulty: "hard" },
    { name: "Bahrein", code: "bh", difficulty: "hard" },
    ...
    { name: "Butão", code: "bt", difficulty: "medium" },
    ...
    { name: "Armênia", code: "am", difficulty: "medium" },
    { name: "Geórgia", code: "ge", difficulty: "medium" },
    ...
    { name: "Camarões", code: "cm", difficulty: "medium" },
    { name: "Costa do Marfim", code: "ci", difficulty: "medium" },
    ...
    { name: "Mônaco", code: "mc", difficulty: "medium" },
    ...
    { name: "Eslovênia", code: "si", difficulty: "medium" },
    { name: "Eslováquia", code: "sk", difficulty: "medium" },
    { name: "Bósnia e Herzegovina", code: "ba", difficulty: "medium" },
    { name: "Montenegro", code: "me", difficulty: "hard" },
    { name: "Macedônia do Norte", code: "mk", difficulty: "hard" },
    { name: "Albânia", code: "al", difficulty: "medium" },
    { name: "Moldávia", code: "md", difficulty: "medium" },
